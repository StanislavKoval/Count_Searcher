...
//////////*** как варик написать метод def file_creator(name,place)
"""
...
def bb ():
    ...
    for word in set_bad_tegs:
        ...
        for i in list_of_bad_str:
            ...
            vocab[word] = buffer
    vocab_1=vocab
    #print(tabulate(vocab.items(), headers=['word', 'strings'], tablefmt="grid"))
...
str3=count_finder(file=file_1, SEARCH_WORD='Бита ЗУБР МАСТЕР с 1/4 НР 2',column_name='Fullname')
print(str3)
...
'''
нужно допилить функицию которая бы по bad_words
находила строки содержащие эти слова в исходном файле 
и из них создала бы файл состоящий из неправильно классифицированных строк
плюс нужно учесть, что лучшим решением стало бы записывать в файл по словам  
'''
