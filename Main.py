...
# new_data_list=[['10.10', 'БИТА'], ['10.10', 'Бита'], ['10.10', 'Бита 1/4"'], ['10.10', 'Бита 100мм'], ['10.10', 'Бита ЗУБР МАСТЕР с 1/4 НР 2'], ['UNK', 'Костюм охрана-с размер 56-58  рост 182-188   ( депо Баумана)'], ['UNK', 'Перчатки желтые резиновые размер XL '], ['10.01', '90 минут 2 поездка  17.12.14 МосГосТранс'], ['10.12', 'Средство чистящее универсальное (Пемолюкс 480 г)'], ['10.113', 'Принтер сканер Brother XXXX'], ['10.12', 'Стол “Премьер-Элит“ разм. 80Х150х120см черн.'], ['10.11.18', 'Путевка „"Golden CARD"“ пансионат «"Ананасовый изумруд"»  "ВАО Москва"'], ['10.12', 'деталь шайба завод «Ракетно космическая корпорация»'], ['10.05', 'Утяжелитель конуса КС-27'], ['10.05', 'Ф/диск KingSton DT101G2/32GB'], ['10.05', 'Фара (блок фары) 30.3775.000 правая МАЗ Евро'], ['10.05', 'Фара (блок фары) левая МАЗ Евро'], ['10.05', 'Фара (фонарь)противотуман.'], ['10.05', 'Фара б/у'], ['10.05', 'Фара в сборе'], ['10.05', 'Фара Волжанин ближнего света'], ['10.05', 'Фара Волжанин'], ['10.05', 'Фара Г-3102'], ['10.09', 'Билет входной'], ['10.09', 'Биотуалет']]
...
прогон малой части
подготовить доклад о проделанной работе за полгода 

препроцессор для номенклатурных данных
word2vec Тани
переписал проект first

тестирование МИА
Теория по НС, курс козлова, книга
Разметка данных
